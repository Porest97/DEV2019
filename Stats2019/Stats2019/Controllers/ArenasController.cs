...
namespace Stats2019.Controllers
{
    public class ArenasController : Controller
    {
        ...
        public ArenasController(Stats2019Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ArenaName,PhoneNumber")] Arena arena)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ArenaName,PhoneNumber")] Arena arena)
        {
            if (id != arena.Id)
            {
                return NotFound();
